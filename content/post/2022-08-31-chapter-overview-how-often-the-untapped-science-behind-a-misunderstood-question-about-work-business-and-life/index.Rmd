...
**What follows is the first draft of the chapter overview section for a book proposal. The book I'm proposing to write is called _How Often? The Untapped Science Behind A Misunderstood Question About Work, Business, and Life_.**

**A chapter overview describes what will happen in each part and chapter of the book. This definitely needs editing, because usually you want it to be under 3,000 words, but this is nearly 5,000. Surely, some of the content here will move into the book overview section of the proposal, or just be cut for length.**

**The book aims to make _event history analysis_ (also called duration modeling, or failure analysis, and part of it called survival analysis) a household name among business leaders. Event history analysis is the beautiful, extensible, flexible, and sadly underused science of how often stuff happens.**

**It will explain intuitively what event history analysis is, how to do it, mistakes to avoid, and how to use it to guide business strategy, decision-making, and product design.**
...
I introduce the book’s central claim: A fundamental question about work, business, and life itself is simply, “How often does stuff happen?” I let that question hang in readers’ minds as I embark on a brief but entertaining tangent about the etymology of the word “often” and its synonym “seldom.” This paired etymology, I argue, is a metaphor for both the question, “How often?”, and the misunderstandings that many people have about it.
...
=======
The fourth character in the book is the set of data sources I use to demonstrate the decision-making tools and product features made possible by event history analysis. First and foremost among these data sources is payroll and human resource records from ADP human capital management systems. I explain that most examples come from workforce management. Not only is this field my area of expertise. Because the robots and algorithms have yet to take over, most businesses still employ people, making workforce management a common issue.
>>>>>>> d42bf453196285c9a0c25063970042a3cbf7c4c8
...
### Chapter 10: [Product guidance: What to build]
