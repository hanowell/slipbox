...
1. The project notes are specific to a particular project and get archived once the project is complete.
1. The naming convention for a note URL will be "[slipbox root]/YYYY/MM/DD/[descriptive note slug]".
1. Sometimes, project notes will emerge bottom-up from the slipbox.
1. As time goes on, I will create index pages to track lines of thought and projects.
1. Where appropriate, my Amazon-specific slipbox will reference my public slipbox, in which case I'll include the note URL in the "Related notes" section of a note.
1. Where appropriate, my public slipbox will reference my Amazon-specific slipbox, in which case I'll only include the note URL date and slug for security reasons in the "Related Amazon notes" section of the note.
